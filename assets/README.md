...
The bot code already reads `RICH_PRESENCE_ASSET_KEY` from the environment. The current default key in `config.py` matches the asset key shown in the supplied Developer Portal screenshot.
